...
import be.kdg.programming6.project.restaurantmanagement.port.in.ChangeOpeningHoursCommand;
import be.kdg.programming6.project.restaurantmanagement.port.in.ChangeOpeningHoursUseCase;
...
@Service
public class ChangeOpeningHoursUseCaseImpl implements ChangeOpeningHoursUseCase {

    private final LoadRestaurantPort loadRestaurantPort;
    private final List<UpdateRestaurantPort> updateRestaurantPort;

    public ChangeOpeningHoursUseCaseImpl(LoadRestaurantPort loadRestaurantPort, List<UpdateRestaurantPort> updateRestaurantPort) {
    ...
    @Override
    @Transactional
    public Restaurant changeOpeningHours(ChangeOpeningHoursCommand command) {
        Restaurant restaurant = loadRestaurantPort.loadById(RestaurantId.of(command.restaurantId())).get();
        restaurant.updateOpeningHours(command.openingHours());
